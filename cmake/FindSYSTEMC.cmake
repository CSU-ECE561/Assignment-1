...
EXEC_PROGRAM("cat ${_SYSTEMC_VERSION_FILE} |grep '#define SC_RELEASE_STRING' | awk {print\\$3} "
        OUTPUT_VARIABLE SYSTEMC_VERSION_LEGACY)

set(SYSTEMC_VERSION ${SYSTEMC_MAJOR}.${SYSTEMC_MINOR}.${SYSTEMC_PATCH})

message("systemc legacy version:${SYSTEMC_VERSION_LEGACY}")

if("${SYSTEMC_MAJOR}" MATCHES "2")
    set(SYSTEMC_FOUND TRUE)
endif("${SYSTEMC_MAJOR}" MATCHES "2")

if("${SYSTEMC_VERSION_LEGACY}" MATCHES "2.2.0")
    set(SYSTEMC_FOUND TRUE)
    SET(SYSTEMC_VERSION SYSTEMC_VERSION_LEGACY)
endif("${SYSTEMC_VERSION_LEGACY}" MATCHES "2.2.0")
...
if("${SYSTEMC_LIBRARY_DIRS}" MATCHES "SYSTEMC_LIBRARY_DIRS-NOTFOUND")
    FIND_PATH(SYSTEMC_LIBRARY_DIRS
            NAMES libsystemc.a
            HINTS ${_SYSTEMC_HINTS}
            PATHS ${_SYSTEMC_PATHS}
...
ENDIF("${SYSTEMC_LIBRARY_DIRS}" MATCHES "SYSTEMC_LIBRARY_DIRS-NOTFOUND")
